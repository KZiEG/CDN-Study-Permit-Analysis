...
#Adding in appropriate years to the column names 
...
#Could look at correlation between study permits and datasets on world bank

```

* Next steps could be bring in data for the other 3 types of temporary residents.

* this is work permits, visitor records, and temporary resident permits.  
